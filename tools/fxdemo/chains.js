...
//     --eval tools/fxdemo/chains.js --out /tmp/chains-400.png --settle 400
//
// --settle is MILLISECONDS after the effect is triggered. This motif runs for
// roughly 1200ms, so take a SPREAD of shots across it and look at each one.
...
(() => {
  ...
  T.resync();
  const ev = { kind: 'chains', from: friend, to: foe };
  T.fx.play(ev);
