...
//     --eval tools/fxdemo/depthcharge.js --out /tmp/depthcharge-300.png --settle 700
//
...
(() => {
  ...
  T.fx.play({ kind: 'depthcharge', at: me, faction: 'Marvorren' });
  for (let t = 0; t < at; t += 1 / 120) real(1 / 120);
  return 'played depthcharge frozen at ' + at.toFixed(2) + 's';
})()
