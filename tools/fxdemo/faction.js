...
//   node tools/shot.js --url "game/?quick=1&seed=5" --eval tools/fxdemo/faction.js \
//     --out /tmp/faction.png --settle 500
...
(() => {
  ...
  T.resync();
  const FX = (window.__FX_EVENT) || { kind: 'cast', at: me, faction: 'Refractory' };
  T.fx.play(FX);
