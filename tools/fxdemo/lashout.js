// Preview harness for ONE motif: lashout.
//
//   node tools/shot.js --url "game/?quick=1&seed=5&t=300" \\
//     --eval tools/fxdemo/lashout.js --out /tmp/lashout-300.png --settle 700
//
...
(() => {
  ...
  T.fx.play({ kind: 'lashout', at: me, faction: 'Marvorren' });
  for (let t = 0; t < at; t += 1 / 120) real(1 / 120);
  return 'played lashout frozen at ' + at.toFixed(2) + 's';
})()
