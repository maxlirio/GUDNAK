...
//     --eval tools/fxdemo/reveal.js --out /tmp/reveal-300.png --settle 700
//
...
(() => {
  ...
  T.fx.play({ kind: 'reveal', at: me, faction: 'Refractory' });
  for (let t = 0; t < at; t += 1 / 120) real(1 / 120);
  return 'played reveal frozen at ' + at.toFixed(2) + 's';
})()
