...
//     --eval tools/fxdemo/decree.js --out /tmp/decree-300.png --settle 700
//
...
(() => {
  ...
  T.fx.play({ kind: 'decree', at: me, faction: 'Gloaming' });
  for (let t = 0; t < at; t += 1 / 120) real(1 / 120);
  return 'played decree frozen at ' + at.toFixed(2) + 's';
})()
