// Preview harness for the thread motifs. Used with tools/shot.js:
//   node tools/shot.js --url "game/?quick=1&seed=5" --eval tools/fxdemo/thread.js \
//     --out /tmp/thread.png --settle 500
...
(() => {
  ...
  T.resync();
  const FX = (window.__FX_EVENT) || { kind: 'threads', at: me };
  T.fx.play(FX);
