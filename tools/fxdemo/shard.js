// Preview harness for the shard motifs. Used with tools/shot.js:
//   node tools/shot.js --url "game/?quick=1&seed=5" --eval tools/fxdemo/shard.js \
//     --out /tmp/shard.png --settle 500
...
(() => {
  ...
  T.resync();
  const FX = (window.__FX_EVENT) || { kind: 'shardfire', at: foe };
  T.fx.play(FX);
