...
//     --eval tools/fxdemo/trapspring.js --out /tmp/trapspring-300.png --settle 700
//
...
(() => {
  ...
  T.fx.play({ kind: 'trapspring', at: me, faction: 'Shardsworn' });
  for (let t = 0; t < at; t += 1 / 120) real(1 / 120);
  return 'played trapspring frozen at ' + at.toFixed(2) + 's';
})()
